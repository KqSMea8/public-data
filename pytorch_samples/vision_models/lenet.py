...
class LeNet5(nn.Module):
    def __init__(self):
        super().__init__() #输入为32*32
        self.conv1 = nn.Conv2d(1, 6, 5, padding=2) #1通道，6个过滤器，过滤器5*5, 周围填充2个像素
        self.conv2 = nn.Conv2d(6, 16, 5)
        self.fc1 = nn.Linear(16*5*5, 120) #16个通道，5*5的？
        self.fc2 = nn.Linear(120, 84)
        self.fc3 = nn.Linear(84, 10)

    def forward(self, x):
        #max_pool2d，relu没有权重要计算，直接用函数形式
        x = F.max_pool2d(F.relu(self.conv1(x)), (2, 2)) # 卷积->relu->最大池化 
